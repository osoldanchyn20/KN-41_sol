...
## Виконані лабораторні роботи з курсу **"Чисельні методи"** 👇
...
## Виконані лабораторні роботи з курсу **"Методи Мат-моделювання"** та **"Тестування"** 👇

- **Лабораторна робота №** 1: [Робота у віртуальних середовищах](./testing/1_lab/README.md)
- **Лабораторна робота №** 2 : [Написання тестів на Python](./testing/2_lab/README.md)
- **Лабораторна робота №** 3 : [Автоматизація процесу тестування](./testing/3_lab/README.md)
- **Лабораторна робота №** 4 : [Візуалізація результатів дослідження](./matplotlib_basics/4_lab/README.md)
- **Лабораторна робота №** 5 : [Розвʼязання задач лінійного програмування](./matplotlib_basics/5_lab/README.md)
